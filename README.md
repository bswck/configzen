...
As a result, comments in your configuration files are lost on save, but you can interchange file formats without any hassle, as well as describe particular particular configuration items throughout configuration model fields (`field: T = ConfigField(description=...)`).
